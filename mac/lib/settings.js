...
const { KEY, isValidCode } = require('./keys');

const DEFAULTS = {
    cps: 12,
    button: 'left',
    mode: 'toggle',
    // На ноутбуке нет ни средней, ни боковых кнопок мыши, поэтому бинд стоит
    // на клавише: правый Command лежит под большим пальцем и в играх не занят.
    bind: KEY.COMMAND_RIGHT,
...
function normalize(raw) {
    ...
    const bind = isValidCode(source.bind) ? source.bind : DEFAULTS.bind;
