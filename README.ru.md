...
![Плашка поверх окон: включение, сжатие в пилюлю, итог захода](docs/media/demo.ru.gif)
...
|---|---|---|
| ![Карточка «Автокликер включён»](docs/media/overlay-wide.ru.png) | ![Пилюля со скоростью и счётом](docs/media/overlay-pill.ru.png) | ![Карточка с итогом захода](docs/media/overlay-result.ru.png) |
...
| Выключен | Работает |
|---|---|
| ![Окно кликера в покое](docs/media/window-idle.ru.png) | ![Окно кликера во время работы](docs/media/window-running.ru.png) |

Стекло — системный акрил Windows 11 плюс собственный слой, поэтому окно остаётся читаемым и там, где акрила нет.

## Русский и английский

<img src="docs/media/window-language.png" alt="Первый запуск спрашивает язык интерфейса" width="330">
